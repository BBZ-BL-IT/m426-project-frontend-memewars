...
// Gleiche Encoding-Logik wie im Backend
...
export default function GameView() {
  ...
  useEffect(() => {
    ...
    socket.on("votingStarted", ({ submissions }) => {
        ...
        if (prev <= 1) {
          ...
          if (!isSubmittedRef.current) {
            ...
            socket.emit("submitCaption", {
              ...
              // URL direkt beim Submit bauen — immer korrekt
  ...
  async function handleTextChange(text: string) {
    ...
    if (text.trim() === "" || !memeIdRef.current) {
      // Zurück zum blanken Meme wenn Text leer
  ...
  function handleSubmit() {
    ...
    // URL beim Submit frisch bauen mit aktuellem memeId + Text
    ...
    <div className="home-wrapper">
      ...
      >
        ...
        <div className="home-center" style={{ flex: 2, height: "100%", display: "flex", flexDirection: "column" }}>
          <h2 className="home-title" style={{ fontSize: "2rem", marginBottom: "20px" }}>
            Create your Meme
          </h2>
          ...
          >
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                ...
                <span style={{ color: timerColor, fontWeight: "bold", fontSize: "1.4rem", fontVariantNumeric: "tabular-nums" }}>
                  {timeLeft}s
                </span>
              </div>
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                borderRadius: "12px",
                cursor: isSubmitted || !inputText.trim() ? "not-allowed" : "pointer",
                background: isSubmitted
                  ? "rgba(0,200,100,0.2)"
                  : "linear-gradient(135deg, #7eb8f7 0%, #a78bfa 100%)",
                color: isSubmitted ? "#7af798" : "#0a0a0a",
                boxShadow: isSubmitted
                  ? "none"
                  : "0 0 24px rgba(126,184,247,0.4), 0 4px 15px rgba(0,0,0,0.3)",
            ...
            {totalPlayers > 0 && (
              <div style={{ marginTop: "24px" }}>
                <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.85rem", marginBottom: "10px" }}>
                  {submittedPlayers.length} / {totalPlayers} abgegeben
                </p>
